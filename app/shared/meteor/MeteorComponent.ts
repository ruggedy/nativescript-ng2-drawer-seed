...
import {isMeteorCallbacks, isCallbacksObject, g, gZone} from './utils';
import {DataObserver} from './data_observer';
import {isBoolean, isFunction} from '@angular/core/src/facade/lang';
 ...
 */
export default class MeteorComponent implements OnDestroy {
